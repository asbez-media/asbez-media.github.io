...
function Package(props: any) {
  ...
  return (
    <div className='h-full flex flex-col max-w-lg p-8 mx-auto text-center text-gray-900 border border-gray-100 shadow bg-graph-paper dark:border-gray-600 dark:bg-graph-paper-dark dark:text-white '>
      ...
      <ol className='space-y-4 text-left list-disc list-inside	px-5'>
